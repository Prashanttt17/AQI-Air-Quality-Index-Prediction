  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          <p className="text-sm">
            <strong>Note:</strong> When backend integration is enabled, predictions will be generated by the 
            backend server using actual machine learning models instead of the simulated predictions in the frontend.
          </p>
        </div>
      </CardContent>
